...
export const copy = {
  ...
  hero: {
    ...
    headline: {
      before: "TVOJA PREDSTAVA O ",
      accent: "ZDRAVIM POSLASTICAMA",
      after: " ZAUVEK ĆE SE PROMENITI ČIM VIDIŠ OVO.",
    },
    subheadline:
      "Bez glutena, mleka i šećera, a opet mekani, pahuljasti i neodoljivo ukusni kolači – pronađi 500 recepata i uživaj u svakom zalogaju, bez griže savesti i bez ikakvog odricanja.",
